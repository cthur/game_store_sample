...
class AccessoriesControllerTest < ActionController::TestCase
  ...
  test "should create accessory" do
    assert_difference('Accessory.count') do
      post :create, accessory: { instore: @accessory.instore, name: @accessory.name, online: @accessory.online, platform: @accessory.platform, price: @accessory.price, quantity: @accessory.quantity }
    end
  ...
  test "should update accessory" do
    patch :update, id: @accessory, accessory: { instore: @accessory.instore, name: @accessory.name, online: @accessory.online, platform: @accessory.platform, price: @accessory.price, quantity: @accessory.quantity }
    assert_redirected_to accessory_path(assigns(:accessory))
  end

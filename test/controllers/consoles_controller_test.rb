...
class ConsolesControllerTest < ActionController::TestCase
  ...
  test "should create console" do
    assert_difference('Console.count') do
      post :create, console: { abbr: @console.abbr, company: @console.company, image_path: @console.image_path, name: @console.name, release_date: @console.release_date }
    end
  ...
  test "should update console" do
    patch :update, id: @console, console: { abbr: @console.abbr, company: @console.company, image_path: @console.image_path, name: @console.name, release_date: @console.release_date }
    assert_redirected_to console_path(assigns(:console))
  end
